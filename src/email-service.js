  ...
  async sendDailyReport(reportData, attachmentPaths = []) {
    ...
    html += `
        ...
        <p style="color: #666; font-size: 12px;">
          Please find the comprehensive Daily Business Report along with detailed Sales and Financial reports attached as PDF files.
        </p>
        <p style="color: #666; font-size: 12px;">
          The Daily Report includes all dashboard metrics, performance indicators, and business insights.
        </p>
      </div>
    `;
