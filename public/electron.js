...
const Database = require("../src/database");                    // SQLite database operations
const PrinterService = require("../src/printer-service");       // Thermal printer integration
const PDFService = require("../src/pdf-service");               // PDF generation for bills/reports
const ReportService = require("../src/services/reportService"); // Business report generation
const DailyReportService = require("../src/services/dailyReportService"); // Daily summary reports
const EmailService = require("../src/email-service");           // Email automation
const { initializeSampleData } = require("../src/init-sample-data"); // Sample data for testing
...
ipcMain.handle("get-sale-with-items", async (event, saleId) => {
  ...
  try {
    const result = await database.getSaleWithItems(saleId);
    console.log('getSaleWithItems result:', result);
    return result;
  } catch (error) {
